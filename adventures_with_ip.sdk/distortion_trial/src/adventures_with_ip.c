...
void menu(){
	...
	xil_printf("\r\n\r\n");
	xil_printf("Embedded Distortion Demo\r\n");
	xil_printf("Enter 's' to stream pure audio, 'n' to add tonal noise, 'f' to distortion when pressed any button and 'd' to distortion continuous.\r\n");
	xil_printf("----------------------------------------\r\n");
